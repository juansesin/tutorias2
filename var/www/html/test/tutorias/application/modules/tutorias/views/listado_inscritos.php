                ...
                <div class="col-md-7">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body no-padding">
                            ...
                            <form  name="asistencia" id="asistencia" method="post" action="<?php echo base_url("tutorias/update_asistencia"); ?>">
                                    ...
                                    foreach ($infoInscritos as $lista):
                                        ...
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                $fechatutoria = $info[0]['fecha_tutoria'];

                                                $fecha = strtotime($fechatutoria);

                                                if (date('Y-m-d', $fecha) <= $fechaactual) {
							...
							echo '<p><strong>' . $valor . '</strong>';
                                ...
                                <?php if (date('Y-m-d', $fecha) <= $fechaactual) { ?>
